...
interface IStudentService_IInsertStudent
	extends grpc.MethodDefinition<mahasiswa_pb.StudentRequest, mahasiswa_pb.StudentResponse> {
...
interface IStudentService_IResultsStudent
	extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, mahasiswa_pb.StudentList> {
...
interface IStudentService_IUpdateStudent
	extends grpc.MethodDefinition<mahasiswa_pb.StudentRequest, mahasiswa_pb.StudentResponse> {
...
export interface IStudentClient {
	insertStudent(
		request: mahasiswa_pb.StudentRequest,
		callback: (error: grpc.ServiceError | null, response: mahasiswa_pb.StudentResponse) => void
	...
	resultsStudent(
		...
		callback: (error: grpc.ServiceError | null, response: mahasiswa_pb.StudentList) => void
	): grpc.ClientUnaryCall
	resultsStudent(
		request: google_protobuf_empty_pb.Empty,
		metadata: grpc.Metadata,
	...
	resultStudent(
		request: mahasiswa_pb.StudentId,
		callback: (error: grpc.ServiceError | null, response: mahasiswa_pb.StudentResponse) => void
	): grpc.ClientUnaryCall
	resultStudent(
		request: mahasiswa_pb.StudentId,
